...
class repair_coilcheck1_0_screen extends StatefulWidget {
  const repair_coilcheck1_0_screen({super.key});

  @override
  State<repair_coilcheck1_0_screen> createState() =>
      _TopcastableChecklistState();
}

class _TopcastableChecklistState extends State<repair_coilcheck1_0_screen> {
  ...
  void initState() {
    ...
    _sinteringItems = _apiService.fetchListItem('14');
