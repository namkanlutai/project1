...
import 'package:engineer/screens/4_repair_coil/widget/widget_button.dart';
...
class repair_coilcheck extends StatefulWidget {
  const repair_coilcheck({super.key});

  @override
  State<repair_coilcheck> createState() => _TopcastableChecklistState();
}

class _TopcastableChecklistState extends State<repair_coilcheck> {
  ...
  void initState() {
    ...
    _sinteringItems = _apiService.fetchListItem('11');
    ...
    Map<String, dynamic> jsonData = {
      ...
      "Details":
        ...
        return {
          ...
          "valuedetail": _controllers[_selectedGroupName]![index].text,
        };
      })
    };
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          ...items.asMap().entries.map((itemEntry) {
                            ...
                            return CardWithButtonsrepaircoil(
                              item: item,
                              index: index,
                              items: items,
                              controller:
