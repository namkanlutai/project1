...
class CoilMetalLeakageDetcor extends StatefulWidget {
  const CoilMetalLeakageDetcor({super.key});

  @override
  State<CoilMetalLeakageDetcor> createState() => _TopcastableChecklistState();
}

class _TopcastableChecklistState extends State<CoilMetalLeakageDetcor> {
