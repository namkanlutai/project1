...
class CoilCheckAntenna extends StatefulWidget {
  const CoilCheckAntenna({super.key});

  @override
  State<CoilCheckAntenna> createState() => _TopcastableChecklistState();
}

class _TopcastableChecklistState extends State<CoilCheckAntenna> {
