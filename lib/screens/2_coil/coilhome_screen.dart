...
class coilhome extends StatefulWidget {
  const coilhome({super.key});

  @override
  State<coilhome> createState() => _coilhomeState();
}

class _coilhomeState extends State<coilhome> {
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      const Text(
                                        'Form : ตารางการตรวจสอบ Coil ก่อนและหลังการตำเตา',
                                        style: TextStyle(
