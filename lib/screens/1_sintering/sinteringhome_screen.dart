...
class sinteringhome extends StatefulWidget {
  const sinteringhome({super.key});

  @override
  State<sinteringhome> createState() => _sinteringhomeState();
}

class _sinteringhomeState extends State<sinteringhome> {
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      const Text(
                                        'Form : Sintering and Dry Coil Cement Check',
                                        style: TextStyle(
