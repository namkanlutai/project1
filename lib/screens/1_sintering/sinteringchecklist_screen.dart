...
class SinteringChecklist extends StatefulWidget {
  final DateTime timestamp;

  const SinteringChecklist({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<SinteringChecklist> createState() => _SinteringChecklistState();
}

class _SinteringChecklistState extends State<SinteringChecklist> {
