...
class AluminumHome extends StatefulWidget {
  const AluminumHome({super.key});

  @override
  State<AluminumHome> createState() => _LiningHomeState();
}

class _LiningHomeState extends State<AluminumHome> {
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      const Text(
                                        'Form : Homel Furnace Preventive Maintenance Report',
                                        style: TextStyle(
                              ...
                              children: [
                                IconButton(
                                  onPressed: () {
                                    Navigator.pushNamed(
                                      context,
                                      AppRouter.aluminumfurnacestructure1,
                                      arguments: r,
                                    );
                                  },
                                  icon: FaIcon(
