...
class lining_insulation extends StatefulWidget {
  final DateTime timestamp;

  const lining_insulation({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<lining_insulation> createState() => _SinteringChecklistState();
}

class _SinteringChecklistState extends State<lining_insulation> {
  ...
  void initState() {
    super.initState();
    getUser();
    _sinteringItems = _apiService.fetchListItem('9');
  ...
  Future<void> _postData(List<ListItem> items, String repairId,
    ...
    Map<String, dynamic> jsonData = {
      ...
      "TypeDetail": "Insulation and waring net for lining",
      "FurnaceNo": 2,
      "HFT": "2 T",
