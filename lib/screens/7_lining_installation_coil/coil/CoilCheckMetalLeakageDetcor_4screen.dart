...
class CoilMetalLeakageDetcor_lining extends StatefulWidget {
  const CoilMetalLeakageDetcor_lining({super.key});

  @override
  State<CoilMetalLeakageDetcor_lining> createState() =>
      _TopcastableChecklistState();
}

class _TopcastableChecklistState extends State<CoilMetalLeakageDetcor_lining> {
  ...
  void initState() {
    ...
    _sinteringItems = _apiService.fetchListItem('7');
  ...
  bool _validateFields() {
    List<int> requiredIndices = [0]; // 0-based index for 1, 2, 3, and 8
    bool allValid = true;
                      ...
                      decoration: InputDecoration(
                        border: const OutlineInputBorder(
                          borderSide: BorderSide(
                            color: Colors
                                .white, // Set the default border color to white
                          ),
                        ),
                        ...
                        labelStyle: const TextStyle(
                          color: icons, // Set the label text color to icons
                        ),
                        hintText: 'Input',
                        hintStyle: const TextStyle(
                          color:
                              icons, // Set the hint text color to a lighter version of icons
                        ),
