...
class CoilCheckAntenna_lining extends StatefulWidget {
  const CoilCheckAntenna_lining({super.key});

  @override
  State<CoilCheckAntenna_lining> createState() => _TopcastableChecklistState();
}

class _TopcastableChecklistState extends State<CoilCheckAntenna_lining> {
  ...
  void initState() {
    ...
    _sinteringItems = _apiService.fetchListItem('6');
  ...
  bool _validateFields() {
    List<int> requiredIndices = [0, 1]; // 0-based index for 1, 2, 3, and 8
    bool allValid = true;
            ...
            children: [
              Row(
                ...
                children: [
                  const Expanded(
                    child: Text(
                      'การตรวจสอบความต้านทานของ 2nd antenna',
                      style: TextStyle(
                        letterSpacing: 0,
