...
class lining_rammingoftaper extends StatefulWidget {
  final DateTime timestamp;

  const lining_rammingoftaper({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<lining_rammingoftaper> createState() => _SinteringChecklistState();
}

class _SinteringChecklistState extends State<lining_rammingoftaper> {
  ...
  void initState() {
    super.initState();
    getUser();
    _sinteringItems = _apiService.fetchListItem('23');
  ...
  Future<void> _postData(List<ListItem> items, String repairId,
    ...
    Map<String, dynamic> jsonData = {
      ...
      "TypeDetail": "Ramming of taper and side wall ด้านข้าง",
      "FurnaceNo": 2,
      "HFT": "2 T",
