...
class lining_dimension extends StatefulWidget {
  final DateTime timestamp;

  const lining_dimension({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<lining_dimension> createState() => _SinteringChecklistState();
}

class _SinteringChecklistState extends State<lining_dimension> {
  ...
  void initState() {
    super.initState();
    getUser();
    _sinteringItems = _apiService.fetchListItem('19');
  ...
  Future<void> _postData(List<ListItem> items, String repairId,
    ...
    Map<String, dynamic> jsonData = {
      ...
      "TypeDetail": "Dimension of furnace inside",
      "FurnaceNo": 2,
      "HFT": "2 T",
