...
class lining_rammingofbottom extends StatefulWidget {
  final DateTime timestamp;

  const lining_rammingofbottom({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<lining_rammingofbottom> createState() => _SinteringChecklistState();
}

class _SinteringChecklistState extends State<lining_rammingofbottom> {
  ...
  void initState() {
    super.initState();
    getUser();
    _sinteringItems = _apiService.fetchListItem('21');
  ...
  Future<void> _postData(List<ListItem> items, String repairId,
    ...
    Map<String, dynamic> jsonData = {
      ...
      "TypeDetail":
          "Ramming of bottom part (deep form the furnace top to lining material)",
      "FurnaceNo": 2,
      "HFT": "2 T",
