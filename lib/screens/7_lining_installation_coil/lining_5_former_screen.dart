...
class lining_former extends StatefulWidget {
  ...
  @override
  State<lining_former> createState() => _SinteringChecklistState();
}

class _SinteringChecklistState extends State<lining_former> {
  ...
  void initState() {
    super.initState();
    getUser();
    _sinteringItems = _apiService.fetchListItem('20');
